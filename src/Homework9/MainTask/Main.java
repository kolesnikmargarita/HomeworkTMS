...
public class Main {
    ...
    public static void main(String[] args) {
        Vector[] vectorsWithTwoParameters = VectorWithTwoParameters.getRandomVectors(3);
        Vector[] vectorsWithThreeParameters = VectorWithThreeParameters.getRandomVectors(2);
